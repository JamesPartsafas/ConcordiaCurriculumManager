...
public interface ICourseRepository
{
    ...
    public Task<int> GetLatestCourseVersion(int courseId);
...
public class CourseRepository : ICourseRepository
{
    ...
    public async Task<int> GetLatestCourseVersion(int courseId) => (await _dbContext.Courses.MaxAsync(course => (int?)course.Version)) ?? 0;
